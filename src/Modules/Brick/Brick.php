...
namespace Twedoo\Stone\Brick;

use StoneStructure;

class Brick extends StoneStructure
{
    /**
    ...
    {
        $this->name = 'Brick';
        $this->nameDisplay = 'Stone Brick CMS Drag & Drop';
    ...
    public function js()
    {
        $js[] = self::route() == 'brick/builder' ? 'dist/build.js' : '';
        return $js;
    }
    ...
    public function css()
    {
        $css[] = self::route() == 'brick/builder' ? 'dist/assets/app.css' : '';
        return $css;
    }
