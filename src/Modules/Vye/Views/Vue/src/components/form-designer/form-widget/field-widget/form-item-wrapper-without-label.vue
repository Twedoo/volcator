<template>
	<div
		...
		<el-form-item
			...
			<template #label :style="{ display: displayStyle }">
		...
		<template v-if="!!designer">
			<div
				...
				class="tw-flex tw-items-center tw-justify-center field-action">
				<i
			...
			<div
				v-if="designer.selectedId === field.id"
				class="drag-handler tw-flex tw-items-center tw-justify-center background-opacity">
...
export default {
	name: 'FormItemWrapperWithoutLabel',
	components: {
		SvgIcon,
	},
	mixins: [i18n],
