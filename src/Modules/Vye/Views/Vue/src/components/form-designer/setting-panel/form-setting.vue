<template>
	<div>
		<el-form
			...
			label-position="left"
			label-width="120px"
			class="setting-form sm-lg:container"
			@submit.prevent>
			<el-collapse v-model="formActiveCollapseNames" class="setting-collapse">
				<el-collapse-item
                    ...
                    <el-form-item :label="i18nt('designer.setting.homePage')">
<!--                        <el-switch v-model="formConfig.homePage"></el-switch>-->
                        <el-radio-group
                            v-model="formConfig.homePage"
					...
					<el-form-item :label="i18nt('designer.setting.formModelName')">
						<el-input v-model="formConfig.modelName" type="text"></el-input>
					</el-form-item>
					<el-form-item :label="i18nt('designer.setting.formRefName')">
						<el-input v-model="formConfig.refName" type="text"></el-input>
					</el-form-item>
					<el-form-item :label="i18nt('designer.setting.formRulesName')">
						<el-input v-model="formConfig.rulesName" type="text"></el-input>
					</el-form-item>
				</el-collapse-item>
		...
		<div
			...
			<el-dialog
				...
				<el-alert
					type="info"
					:closable="false"
					:title="'form.' + eventParamsMap[curEventName]"></el-alert>
				<code-editor
					ref="ecEditor"
...
export default {
	...
	data() {
		return {
			...
			containerConfig: [
				{ label: 'Default', value: 'container-design-lg' },
				{ label: 'Small', value: 'container-design-sm' },
				{ label: 'Medium', value: 'container-design-md' },
				{ label: 'Large', value: 'container-design-lg' },
				{ label: 'xLarge', value: 'container-design-xl' },
				{ label: '2xLarge', value: 'container-design-2xl' },
				{ label: 'Full', value: 'tw-max-w-full' },
			],
