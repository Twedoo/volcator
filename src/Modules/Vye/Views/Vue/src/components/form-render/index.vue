<template>
    <el-form
        ...
        <template v-for="(widget, index) in widgetList">
            <template v-if="'container' === widget.category || 'layout' === widget.category">
                <component
...
export default {
    ...
    methods: {
        ...
        getContainerWidgetName(widget) {
            ...
            //     return "vf-container-item"; //VfContainerItem
            // }
        ...
        buildDataFromWidget(wItem) {
            if (wItem.category === "container") {
                //   if (wItem.type === 'container-base') {
                //       // if (!!wItem.rows && (wItem.rows.length > 0)) {
                //       //     console.log('++++++++++++++++++++++++++++++++++++++++++')
                //       //     wItem.rows.forEach((childItem) => {
                ...
                //       //                 this.buildDataFromWidget(wChild)
                //       //
                //       //             })
                //       //         })
                //       //     })
                ...
                //     //         console.log('++++++++++++++++++++++++++++++++++++++++++')
                //     //         console.log(wItem.type)
                //     //         console.log(wItem.rows)
                //     //         console.log(wItem.rows.length)
                //     //         console.log('++++++++++++++++++++++++++++++++++++++++++')
