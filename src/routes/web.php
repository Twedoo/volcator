        ...
        Route::group(['middleware' => ['auth']], function () {
            ...
            Route::get('roles',
                [
                    ...
                    'middleware' => ['permission:'.Config::get('volcator.PERMISSION_ROLE_ACCESS_CONTROL')]
                ]);
            ...
            Route::get('permissions',
                [
                    ...
                    'middleware' => ['permission:'.Config::get('volcator.PERMISSION_PERMISSION_ACCESS_CONTROL')]
                ]);
