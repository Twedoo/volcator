...
(function (factory) {
  ...
  var async = (function () {
     ...
     *
     * @param {File} file
     * @return {Promise} - then: sDaturlBack
     */
    var readFileAsDaturlBack = function (file) {
      return $.Deferred(function (deferred) {
        $.extend(new FileReader(), {
          onload: function (e) {
            var sDaturlBack = e.target.result;
            deferred.resolve(sDaturlBack);
          },
          onerror: function () {
    ...
    return {
      readFileAsDaturlBack: readFileAsDaturlBack,
  ...
  var EventHandler = function () {
    ...
    this.insertImages = function (layoutInfo, files) {
      ...
      // else insert Image as daturlBack
      } else {
        $.each(files, function (idx, file) {
          ...
          if (options.maximumImageFileSize && options.maximumImageFileSize < file.size) {
            ...
            async.readFileAsDaturlBack(file).then(function (sDaturlBack) {
              modules.editor.insertImage($editable, sDaturlBack, filename);
            }).fail(function () {
              bindCustomEvent($holder, callbacks, 'image.upload.error')(options.langInfo.image.maximumFileSizeError);
            });
          }
