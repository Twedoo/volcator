...
;(function($) {
  ...
  $(function() {
    ...
    $('.cui__menuLeft__trigger').on('click', function() {
      ...
      $('.cui__menuLeft__logo img').toggleClass('setting_trigger_left')
      // $('.cui__menuLeft__trigger').toggleClass('cui__menuLeft__trigger_min')
      // $('.cui__menuLeft').toggleClass('cui__menuLeft_min')
    })
