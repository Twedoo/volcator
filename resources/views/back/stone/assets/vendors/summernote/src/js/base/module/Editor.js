...
import { readFileAsDaturlBack, createImage } from '../core/async';
...
export default class Editor {
  ...
  */
   ...
   * @param {File[]} files
   */
  insertImagesAsDaturlBack(files) {
    $.each(files, (idx, file) => {
      ...
      if (this.options.maximumImageFileSize && this.options.maximumImageFileSize < file.size) {
        ...
        readFileAsDaturlBack(file).then((daturlBack) => {
          return this.insertImage(daturlBack, filename);
        }).fail(() => {
