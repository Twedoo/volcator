...
**/
	...
	// ADD CLASS
	//jQuery("head").append('<link href="styleswitcher.css" rel="stylesheet" type="text/css" />');
	...
	**/
	jQuery("input.dark_switch").bind("click", function() {
		...
		if(color_skin == 'dark') {
			...
			jQuery("head").append('<link id="css_dark_skin" href="resources/assets/assets/css/layout-dark.css" rel="stylesheet" type="text/css" title="dark" />');
	...
	**/
	jQuery("input.rtl_switch").bind("click", function() {
		...
		if(_direction == 'rtl') {
			...
			jQuery("head").append('<link id="rtl_ltr_b1" href="{{asset("resources/assets/assets/plugins/bootstrap/RTL/bootstrap-rtl.min.css")}}" rel="stylesheet" type="text/css" title="rtl" />');
			jQuery("head").append('<link id="rtl_ltr_b2" href="{{asset("resources/assets/assets/plugins/bootstrap/RTL/bootstrap-flipped.min.css")}}" rel="stylesheet" type="text/css" title="rtl" />');
			jQuery("head").append('<link id="rtl_ltr" href="{{asset("resources/assets/assets/css/layout-RTL.css")}}" rel="stylesheet" type="text/css" title="rtl" />');
	...
	function setActiveStyleSheet(title) {
		if(title != 'null' && title != null) {
			jQuery("#color_scheme").attr('href', 'resources/assets/assets/css/color_scheme/' + title + '.css');
	...
	jQuery("select#headerLayout").click(function() {
		...
		jQuery("head").children(":last").attr({
			...
			href: 	"resources/assets/assets/css/navigation-style-" + type + ".css"
		});
