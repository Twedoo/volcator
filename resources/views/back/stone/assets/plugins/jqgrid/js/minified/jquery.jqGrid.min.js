...
"true")):d=!1;if(void 0!==e.daturlBack){d=e.name?String(e.id).substring(0,String(e.id).length-String(e.name).length-1):String(e.id);var l=e.postData||c.postData;k.p&&k.p.idPrefix&&(d=a.jgrid.stripPref(k.p.idPrefix,d));a.ajax(a.extend({url:a.isFunction(e.daturlBack)?e.daturlBack.call(k,d,b,String(e.name)):e.daturlBack,type:"GET",dataType:"html",data:a.isFunction(l)?l.call(k,d,b,String(e.name)):l,context:{elem:g,options:e,vl:b},success:function(b){var c=[],d=this.elem,e=this.vl,f=a.extend({},this.options),g=!0===
