            ...
            <div class="cui__breadcrumbs">
                <div class="cui__breadcrumbs__path">
                    ...
                    <span>
                        <span class="cui__breadcrumbs__arrow"></span>
                        <strong
                            class="cui__breadcrumbs__current">{{ trans('access/roles_managment.permission_create_create') }}</strong>
                    </span>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-5">
                                        ...
                                        <div class="form-actions">
                                            <button type="submit" class="btn btn-dark mr-2 px-5 pull-right">{{ trans('access/roles_managment.permission_create_create_btn') }}</button>
                                        </div>
                                        {!! Form::close() !!}
                                    </div>
                                </div>
