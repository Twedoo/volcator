            ...
            <div class="cui__breadcrumbs">
                <div class="cui__breadcrumbs__path">
                    ...
                    <span>
                        <span class="cui__breadcrumbs__arrow"></span>
                        <strong
                            class="cui__breadcrumbs__current">{{ trans('access/roles_managment.roles_title_edit') }}</strong>
                    </span>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-5">
                                        ...
                                        <div class="form-group @if ($errors->has('display_name')) has-danger @endif">
                                            <label class="form-label">{{ trans('access/roles_managment.roles_edit_name') }}</label>
                                        ...
                                        <div class="form-group @if ($errors->has('description')) has-danger @endif">
                                            <label class="form-label">{{ trans('access/roles_managment.roles_edit_description') }}</label>
