        ...
        <div class="cui__layout__content">
            <div class="cui__breadcrumbs">
                <div class="cui__breadcrumbs__path">
                    ...
                    <span>
                        <span class="cui__breadcrumbs__arrow"></span>
                        <strong
                            class="cui__breadcrumbs__current">{{ trans('Access-Controls::Access-Controls/Access-Controls.show_users_title') }}</strong>
                    </span>
                </div>
            </div>
            <div class="cui__utils__content">
                <div class="kit__utils__heading">
                    <h5>
                        <span class="mr-3">{{ trans('Access-Controls::Access-Controls/Access-Controls.show_users_title') }}</span>
                ...
                <table id="user" class="table table-bordered table-striped">
                    <tbody>
                    <tr>
                        <td width="35%">{{trans('Access-Controls::Access-Controls/Access-Controls.show_users_name')}}</td>
                        <td width="65%"><a href="#" id="username" data-type="text" data-pk="1"
                                           data-title="Enter username"
                                           class="editable editable-click">{{ $user->name }}</a></td>
                    </tr>
                    <tr>
                        <td>{{trans('Access-Controls::Access-Controls/Access-Controls.show_users_email')}}</td>
                    ...
                    <tr>
                        <td>{{trans('Access-Controls::Access-Controls/Access-Controls.show_users_role')}}</td>
