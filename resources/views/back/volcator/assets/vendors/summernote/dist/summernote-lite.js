...
(function (global, factory) {
   ...
   */
  function readFileAsDaturlBack(file) {
      return $$1.Deferred(function (deferred) {
          $$1.extend(new FileReader(), {
              onload: function (e) {
                  var daturlBack = e.target.result;
  ...
  */
  ...
  var Editor = /** @class */ (function () {
      ...
      */
       ...
       * @param {File[]} files
       */
      Editor.prototype.insertImagesAsDaturlBack = function (files) {
          var _this = this;
          $$1.each(files, function (idx, file) {
              ...
              if (_this.options.maximumImageFileSize && _this.options.maximumImageFileSize < file.size) {
                  ...
                  readFileAsDaturlBack(file).then(function (daturlBack) {
                      return _this.insertImage(daturlBack, filename);
                  }).fail(function () {
      ...
      Editor.prototype.insertImagesOrCallback = function (files) {
          ...
          if (callbacks.onImageUpload) {
              ...
              this.insertImagesAsDaturlBack(files);
          }
      };
      /**
