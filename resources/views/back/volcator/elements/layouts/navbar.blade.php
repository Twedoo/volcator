<div class="cui__layout__header">
    <div class="cui__topbar">
      ...
      >
        <i
            class="dropdown-toggle-icon fe fe-star"
            data-toggle="tooltip"
            data-placement="bottom"
            title="Bookmarks"
        ></i>
...
<!--                                            style="background-image: url('../../components/kit/core/img/content/photos/4.jpeg')"-->
        ...
        @if(VolcatorEngine::isInstallVolcatorAsMain('Applications'))
        <div class="dropdown mr-4 d-none d-sm-block">
            <a href="" class="dropdown-toggle text-nowrap" data-toggle="dropdown" data-offset="5,15">
                ...
                <span class="dropdown-toggle-text">
                    {{ VolcatorApplication::getCurrentApplicationName()->name}}
                </span>
            </a>
                ...
                <div style="width: 270px;">
                    <div class="card-header-application ">
                        <div class="row">
                            ...
                            <div class="col-lg-3 text-center">
                                <a href="{{ route(app('urlBack') . '.multi.applications.edit', VolcatorApplication::getCurrentApplicationId()) }}">
                    ...
                    <div class="card-body-application">
                        <div class="row text-center">
                            @foreach (VolcatorApplication::getApplicationsSpaces() as $id => $application)
                                @if ($id != VolcatorApplication::getCurrentApplicationId())
                ...
                <div style="width: 400px;">
                    <div class="card-header-notification">
                        <div class="d-flex justify-content-between">
                            <div class="p-2 volcator-simple-text mt-1">
                                <span class="text-black">
                                    <strong>Notifications</strong>
                                </span>
                            </div>
                            <div class="p-2 volcator-simple-text">
        ...
        <div class="dropdown">
            ...
            >
                <img
                    class="dropdown-toggle-avatar img-display-inline"
